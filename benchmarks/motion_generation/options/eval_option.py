...
class EvalT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument(
            "--num_batch", default=2, type=int, help="Number of batch for generation"
        )
        self.parser.add_argument(
            "--repeat_times",
            default=1,
        ...
        self.parser.add_argument(
            "--time_steps", default=18, type=int, help="Mask Generate steps."
        )
        ...
        self.parser.add_argument(
            "--res_name",
            type=str,
            default="tres_nlayer8_ld384_ff1024_rvq6ns_cdp0.2_sw",
            help="Model name of residual transformer",
        )
        self.parser.add_argument(
            "--text_path", type=str, default="", help="Text prompt file"
        )
        ...
        self.parser.add_argument(
            "--source_motion",
            default="example_data/000612.npy",
            type=str,
