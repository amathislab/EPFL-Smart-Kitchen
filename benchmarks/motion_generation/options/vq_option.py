...
def arg_parse(is_train=False):
    ...
    ## dataloader
    parser.add_argument(
        "--dataset_name", type=str, default="humanml3d", help="dataset directory"
    )
    ...
    parser.add_argument(
        "--action_type", type=str, default="all", help="dataset directory"
    )

    ## optimization
    parser.add_argument(
        "--max_epoch", default=50, type=int, help="number of total epochs to run"
    )
    ...
    parser.add_argument(
        "--recons_loss", type=str, default="l1_smooth", help="reconstruction loss"
    )
    ...
    parser.add_argument(
        "--depth", type=int, default=3, help="num of resblocks for each res"
    )
    parser.add_argument(
        "--dilation_growth_rate", type=int, default=3, help="dilation growth rate"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--quantize_dropout_prob", type=float, default=0.2, help="quantize_dropout_prob"
    )
    # parser.add_argument('--use_vq_prob', type=float, default=0.8, help='quantize_dropout_prob')

    parser.add_argument(
        "--ext", type=str, default="default", help="reconstruction loss"
    )
    ...
    parser.add_argument(
        "--save_every_e", default=2, type=int, help="save model every n epoch"
    )
    parser.add_argument(
        "--eval_every_e", default=1, type=int, help="save eval results every n epoch"
    )
    ...
    parser.add_argument(
        "--which_epoch", type=str, default="all", help="Name of this trial"
    )
    ...
    parser.add_argument(
        "--vq_name",
        type=str,
        default="rvq_nq6_dc512_nc512_noshare_qdp0.2",
