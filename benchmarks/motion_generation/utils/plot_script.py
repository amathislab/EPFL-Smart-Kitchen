...
def plot_3d_motion_v2(
    motion, kinematic_tree, save_path, interval=50, dataset=None, title=None
):
    def init():
        ax.set_xlabel("x")
        ax.set_ylabel("y")
    ...
    def update(index):
        ...
        ax.view_init(elev=110, azim=-90)
        ax.scatter(
            motion[index, :, 0], motion[index, :, 1], motion[index, :, 2], color="black"
        )
        for chain, color in zip(kinematic_tree, colors):
            ax.plot3D(
...
def plot_3d_motion_kit(
    ...
    def update(index):
        ...
        ax.scatter(
            data[index, :, 0], data[index, :, 1], data[index, :, 2], color="black"
        )
        for chain, color in zip(kinematic_tree, colors):
            ax.plot3D(
                data[index, chain, 0],
...
def plot_3d_motion_v2(
    ...
    # Remove 'Agg' backend to allow figure rendering
...
def plot_3d_multi_motion(
    motion_list, kinematic_tree, save_path, interval=50, dataset=None
):
    matplotlib.use("Agg")
